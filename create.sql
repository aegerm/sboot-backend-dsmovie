...
create table tb_score (score float8, movie_id int8 not null, user_id int8 not null, primary key (movie_id, user_id))
...
INSERT INTO tb_score(movie_id, user_id, score) VALUES (1, 1, 5.0)
INSERT INTO tb_score(movie_id, user_id, score) VALUES (1, 2, 4.0)
INSERT INTO tb_score(movie_id, user_id, score) VALUES (2, 1, 3.0)
INSERT INTO tb_score(movie_id, user_id, score) VALUES (2, 2, 3.0)
INSERT INTO tb_score(movie_id, user_id, score) VALUES (2, 3, 4.0)
create table tb_movie (id int8 generated by default as identity, count int4, image varchar(255), score float8, title varchar(255), primary key (id))
create table tb_score (score float8, movie_id int8 not null, user_id int8 not null, primary key (movie_id, user_id))
create table tb_user (id int8 generated by default as identity, email varchar(255), primary key (id))
alter table if exists tb_score add constraint FK23yhb6qop0f6hnb72hcorm3cv foreign key (movie_id) references tb_movie
